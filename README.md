# anylogger-console <sub><sup>1.1.0-beta.3</sup></sub>
...
* [anylogger-console.js](https://unpkg.com/anylogger-console@1.1.0-beta.3/anylogger-console.js)
  (fully commented source ~5kB)
* [anylogger-console.min.js](https://unpkg.com/anylogger-console@1.1.0-beta.3/anylogger-console.min.js)
...
<script src="https://unpkg.com/anylogger-console@1.1.0-beta.3/"></script>
